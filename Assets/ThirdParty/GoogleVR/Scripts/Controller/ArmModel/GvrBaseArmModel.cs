...
public abstract class GvrBaseArmModel : MonoBehaviour {
  ...
  public abstract Vector3 ControllerPositionFromHeadLeft { get; }
    public abstract Vector3 ControllerPositionFromHeadRight { get; }

    /// Quaternion to represent the controller's rotation relative to
    /// the user's head position.
    public abstract Quaternion ControllerRotationFromHeadLeft { get; }
    public abstract Quaternion ControllerRotationFromHeadRight { get; }
